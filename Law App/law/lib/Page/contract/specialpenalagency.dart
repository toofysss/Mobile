...
class SpecialPenalAgencyController extends GetxController {
...
class SpecialPenalAgency extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SpecialPenalAgencyController>(
        init: SpecialPenalAgencyController(),
        builder: (controller) {
          return Scaffold(
                        ...
                        child: CustomButton(
                            ...
                            ontap: () {
                              ContactClass.createPdf(
                                  'وكالة جزائية خاصة',
                                  " الوكيل : ${controller.laweyrsname.text} \n الموكل : ${controller.username.text} \n الخصم : ${controller.laweyrsaddress.text} \n نوع الدعوى : جزائية \n رقم الدعوى : ${controller.price.text} \n أسم المحكمة : ${controller.lawname.text}",
                                  '',
                                  '',
                                  '',
                                  '',
