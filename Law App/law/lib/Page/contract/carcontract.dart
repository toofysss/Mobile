...
class CarContractController extends GetxController {
...
class CarContract extends StatelessWidget {
  final String title;
  const CarContract({required this.title, super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CarContractController>(
        init: CarContractController(),
        builder: (controller) {
          return Scaffold(
                      ...
                      Container(
                          ...
                          child: CustomButton(
                              ...
                              ontap: () {
                                ...
                                String carRestorePrice = Tafqeet.convert(
                                    controller.carRestorePrice.text);
                                ContactClass.createPdf(
                                    'عقد بيع وشراء السيارات',
                                    '',
                                    ...
                                    '',
                                    '''
        اولاً :: باع الطرف الأول للطرف الثاني السيارة المرقمه ${controller.carNo.text} خصوصي / أجره / حمل 
        ...
        وقد قبض البائع مبلغ قدره ${controller.carpayment.text} كتابة   $carpayment ${controller.gender} 
        والباقي قدره ${controller.carRestorePrice.text} كتابة   $carRestorePrice ${controller.gender} 
        ...
        الملاحظات ::
        1.على البائع والمشتري الالتزام بتسجيل السيارة حسب قانون المرور والمعرض غير مسؤول خلاف ذلك .
        2.الطرف الأول وهو البائع مسؤول عن دفع كافة الغرامات المرورية والكمركية و الضرائب وجميع ما يترتب على السيارة من ديون او دعاوى في المحاكم لغاية يوم البيع .
