...
// المعلومات ٣
class NewInformation3 extends StatefulWidget {
  const NewInformation3({super.key});

  @override
  State<NewInformation3> createState() => _NewInformation3State();
}

class _NewInformation3State extends State<NewInformation3> {
