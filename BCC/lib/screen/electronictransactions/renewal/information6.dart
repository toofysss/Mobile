...
// المعلومات ١
class Information6 extends StatefulWidget {
  const Information6({super.key});

  @override
  State<Information6> createState() => _Information6State();
}

class _Information6State extends State<Information6> {
  @override
