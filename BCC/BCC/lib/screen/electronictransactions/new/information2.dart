...
// المعلومات ٢
class NewInformation2 extends StatefulWidget {
  const NewInformation2({super.key});

  @override
  State<NewInformation2> createState() => _NewInformation2State();
}

class _NewInformation2State extends State<NewInformation2> {
  @override
