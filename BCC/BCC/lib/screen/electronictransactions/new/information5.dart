...
// معلومات ٤
class NewInformation5 extends StatefulWidget {
  const NewInformation5({super.key});

  @override
  State<NewInformation5> createState() => _NewInformation5State();
}

class _NewInformation5State extends State<NewInformation5> {
                              ...
                              child: Container(
                                  ...
                                  child:
                                      ...
                                      CustomButton(
                                          data: "116".tr,
                                          onTap: () {
                                            if (ElectronicTransactionsClass.backResidenceCard == null ||
                                                ElectronicTransactionsClass
                                                        .frontResidenceCard ==
                                                    null ||
                                                ElectronicTransactionsClass
